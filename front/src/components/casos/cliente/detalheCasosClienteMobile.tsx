...
interface DetalheCasosClienteMobileProps {
    casoId: string;
}

export function DetalheCasosClienteMobile ({ casoId }: DetalheCasosClienteMobileProps)  {
    ...
    return (
        <div className="p-4 bg-background text-foreground">
            <h1 className="text-2xl font-bold mb-4">{caso.titulo}</h1>
