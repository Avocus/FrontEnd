    ...
    <div className={`bg-background text-foreground ${isMobile ? 'p-4' : 'p-8'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="border rounded-lg p-4">
          ...
          <div className="space-y-2">
            <p><span className="font-medium">Nome:</span> {caso.cliente.nome}</p>
            <p><span className="font-medium">Email:</span> {caso.cliente.email}</p>
            <p><span className="font-medium">Telefone:</span> {caso.cliente.telefone}</p>
          </div>
        </div>
      </div>
      ...
      <div className="border rounded-lg p-4">
        <h2 className="text-xl font-semibold mb-2">Movimentações</h2>
        <div className="space-y-2">
